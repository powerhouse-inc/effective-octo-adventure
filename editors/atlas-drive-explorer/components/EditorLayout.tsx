        ...
        */}
        <div
          className={cn(
            ...
            "flex h-9 rounded-md text-sm font-normal leading-5 text-gray-900 border border-gray-300 bg-white px-3 py-2 font-sans placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-900 focus-visible:ring-offset-0 focus-visible:ring-offset-white focus:bg-gray-50 disabled:cursor-not-allowed disabled:border-gray-300 disabled:bg-white disabled:text-gray-700 w-full appearance-none !pl-8",
