...
const ContentCard = ({ tagText = "Official Atlas", variant = "gray", children, className }: AtlasCardProps) => {
  return (
    <div className={`flex flex-col w-full border border-gray-200 rounded-md  bg-gray-50 ${className}`}>
