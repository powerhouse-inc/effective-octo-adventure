...
type Mutation {
    ...
    AtlasMultiParent_setName(driveId:String, docId:PHID, input:AtlasMultiParent_SetNameInput): Int
    AtlasMultiParent_setContent(driveId:String, docId:PHID, input:AtlasMultiParent_SetContentInput): Int
    AtlasMultiParent_setMasterStatus(driveId:String, docId:PHID, input:AtlasMultiParent_SetMasterStatusInput): Int
    AtlasMultiParent_addParent(driveId:String, docId:PHID, input:AtlasMultiParent_AddParentInput): Int
    AtlasMultiParent_setAtlasType(driveId:String, docId:PHID, input:AtlasMultiParent_SetAtlasTypeInput): Int
    AtlasMultiParent_removeParent(driveId:String, docId:PHID, input:AtlasMultiParent_RemoveParentInput): Int
    AtlasMultiParent_replaceParent(driveId:String, docId:PHID, input:AtlasMultiParent_ReplaceParentInput): Int
    AtlasMultiParent_addTags(driveId:String, docId:PHID, input:AtlasMultiParent_AddTagsInput): Int
    AtlasMultiParent_removeTags(driveId:String, docId:PHID, input:AtlasMultiParent_RemoveTagsInput): Int
    AtlasMultiParent_addContextData(driveId:String, docId:PHID, input:AtlasMultiParent_AddContextDataInput): Int
    AtlasMultiParent_removeContextData(driveId:String, docId:PHID, input:AtlasMultiParent_RemoveContextDataInput): Int
    AtlasMultiParent_replaceContextData(driveId:String, docId:PHID, input:AtlasMultiParent_ReplaceContextDataInput): Int
    AtlasMultiParent_setNotionId(driveId:String, docId:PHID, input:AtlasMultiParent_SetNotionIdInput): Int
}
...
"""
"""
Naming convention for operations, where we don't include the specific document type AtlasMultiParent_name in the name. 
"""
