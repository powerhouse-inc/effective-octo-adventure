...
const client = {
  ...
  mutations: {
    AtlasExploratory_createDocument: apiEndpoint(
      "mutation",
      "AtlasExploratory_createDocument",
    ),
    AtlasExploratory_setExploratoryName: apiEndpoint(
      "mutation",
      "AtlasExploratory_setExploratoryName",
    ),
    AtlasExploratory_setDocNumber: apiEndpoint(
      "mutation",
      "AtlasExploratory_setDocNumber",
    ),
    AtlasExploratory_setContent: apiEndpoint(
      "mutation",
      "AtlasExploratory_setContent",
    ),
    AtlasExploratory_setMasterStatus: apiEndpoint(
      "mutation",
      "AtlasExploratory_setMasterStatus",
    ),
    AtlasExploratory_setParent: apiEndpoint(
      "mutation",
      "AtlasExploratory_setParent",
    ),
    AtlasExploratory_removeParent: apiEndpoint(
      "mutation",
      "AtlasExploratory_removeParent",
    ),
    AtlasExploratory_setAtlasType: apiEndpoint(
      "mutation",
      "AtlasExploratory_setAtlasType",
    ),
    AtlasExploratory_setFindings: apiEndpoint(
      "mutation",
      "AtlasExploratory_setFindings",
    ),
    AtlasExploratory_addTags: apiEndpoint(
      "mutation",
      "AtlasExploratory_addTags",
    ),
    AtlasExploratory_removeTags: apiEndpoint(
      "mutation",
      "AtlasExploratory_removeTags",
    ),
    AtlasExploratory_addContextData: apiEndpoint(
      "mutation",
      "AtlasExploratory_addContextData",
    ),
    AtlasExploratory_removeContextData: apiEndpoint(
      "mutation",
      "AtlasExploratory_removeContextData",
    ),
    AtlasExploratory_setProvenance: apiEndpoint(
      "mutation",
      "AtlasExploratory_setProvenance",
    ),
    AtlasExploratory_setNotionId: apiEndpoint(
      "mutation",
      "AtlasExploratory_setNotionId",
    ),
    AtlasExploratory_addAdditionalGuidance: apiEndpoint(
      "mutation",
      "AtlasExploratory_addAdditionalGuidance",
    ),
    AtlasExploratory_removeAdditionalGuidance: apiEndpoint(
      "mutation",
