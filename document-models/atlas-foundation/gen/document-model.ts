...
export const documentModel: DocumentModelState = {
  ...
  extension: ".afn",
  description:
    "Foundational document type (Article, Section, CoreDocument, ActiveDataController).",
  author: {
    name: "Sky",
      ...
      modules: [
        {
          ...
          operations: [
            ...
            {
              id: "v4PAjAoE3LbwBkfqgp1Tb/ectpA=",
              name: "SET_DOC_NUMBER",
              description: "",
            ...
            {
              id: "qVfkJKEGfwpQrizJW5doBTv0Rh0=",
              name: "ADD_REFERENCE",
              description: "",
              schema:
            ...
            {
              id: "KmUY+sszGz5lcEOtZKHTb9Pop6o=",
        ...
        },
        {
          ...
          operations: [
            ...
            {
              id: "hdblfl0fY4Frt6ek1C8IBsYuQ4U=",
              name: "SET_PROVENANCE",
              description: "",
