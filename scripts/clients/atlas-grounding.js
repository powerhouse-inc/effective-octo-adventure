...
const client = {
  ...
  mutations: {
    AtlasGrounding_createDocument: apiEndpoint(
      "mutation",
      "AtlasGrounding_createDocument",
    ),
    AtlasGrounding_setGroundingName: apiEndpoint(
      "mutation",
      "AtlasGrounding_setGroundingName",
    ),
    AtlasGrounding_setDocNumber: apiEndpoint(
      "mutation",
      "AtlasGrounding_setDocNumber",
    ),
    AtlasGrounding_setContent: apiEndpoint(
      "mutation",
      "AtlasGrounding_setContent",
    ),
    AtlasGrounding_setMasterStatus: apiEndpoint(
      "mutation",
      "AtlasGrounding_setMasterStatus",
    ),
    AtlasGrounding_setAtlasType: apiEndpoint(
      "mutation",
      "AtlasGrounding_setAtlasType",
    ),
    AtlasGrounding_setParent: apiEndpoint(
      "mutation",
      "AtlasGrounding_setParent",
    ),
    AtlasGrounding_addTags: apiEndpoint("mutation", "AtlasGrounding_addTags"),
    AtlasGrounding_removeTags: apiEndpoint(
      "mutation",
      "AtlasGrounding_removeTags",
    ),
    AtlasGrounding_addContextData: apiEndpoint(
      "mutation",
      "AtlasGrounding_addContextData",
    ),
    AtlasGrounding_removeContextData: apiEndpoint(
      "mutation",
      "AtlasGrounding_removeContextData",
    ),
    AtlasGrounding_setProvenance: apiEndpoint(
      "mutation",
      "AtlasGrounding_setProvenance",
    ),
    AtlasGrounding_setNotionId: apiEndpoint(
      "mutation",
      "AtlasGrounding_setNotionId",
    ),
    AtlasGrounding_addReference: apiEndpoint(
      "mutation",
      "AtlasGrounding_addReference",
    ),
    AtlasGrounding_removeReference: apiEndpoint(
      "mutation",
