...
const client = {
  ...
  mutations: {
    AtlasFoundation_createDocument: apiEndpoint(
      "mutation",
      "AtlasFoundation_createDocument",
    ),
    AtlasFoundation_setFoundationName: apiEndpoint(
      "mutation",
      "AtlasFoundation_setFoundationName",
    ),
    AtlasFoundation_setDocNumber: apiEndpoint(
      "mutation",
      "AtlasFoundation_setDocNumber",
    ),
    AtlasFoundation_setContent: apiEndpoint(
      "mutation",
      "AtlasFoundation_setContent",
    ),
    AtlasFoundation_setMasterStatus: apiEndpoint(
      "mutation",
      "AtlasFoundation_setMasterStatus",
    ),
    AtlasFoundation_addReference: apiEndpoint(
      "mutation",
      "AtlasFoundation_addReference",
    ),
    AtlasFoundation_setAtlasType: apiEndpoint(
      "mutation",
      "AtlasFoundation_setAtlasType",
    ),
    AtlasFoundation_removeReference: apiEndpoint(
      "mutation",
      "AtlasFoundation_removeReference",
    ),
    AtlasFoundation_setParent: apiEndpoint(
      "mutation",
      "AtlasFoundation_setParent",
    ),
    AtlasFoundation_addTags: apiEndpoint("mutation", "AtlasFoundation_addTags"),
    AtlasFoundation_removeTags: apiEndpoint(
      "mutation",
      "AtlasFoundation_removeTags",
    ),
    AtlasFoundation_addContextData: apiEndpoint(
      "mutation",
      "AtlasFoundation_addContextData",
    ),
    AtlasFoundation_removeContextData: apiEndpoint(
      "mutation",
      "AtlasFoundation_removeContextData",
    ),
    AtlasFoundation_setProvenance: apiEndpoint(
      "mutation",
      "AtlasFoundation_setProvenance",
    ),
    AtlasFoundation_setNotionId: apiEndpoint(
      "mutation",
